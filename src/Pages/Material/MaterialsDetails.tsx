...
const MaterialsDetails: React.FC<PageBasicProps> = ({ themeMode, type }) => {
  ...
  const { data, error } = useSWR(`http://localhost:8000/api/playlist/${id}`, fetcher);
        ...
        <div className="container">
          ...
          >
            ...
            <div>
              ...
              >
                {isExpanded ? pageData.description : getTruncatedDescription(pageData.description)}
              </p>
      ...
      <SwiperSlide key={index}>
        ...
        >
          ...
          <p className="mt-2 text-lg font-semibold">
            Drake Ignites the Stage with Spectacular New Concert Experience!
          </p>
          <div className="flex gap-2 items-center">
            ...
            >
              ...
              <p className='text-xl mt-2 font-medium'>there is no related data added ...</p>
            )}
