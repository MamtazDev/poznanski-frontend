    ...
    <div>
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg w-full">
        <table className="w-full h-full" style={{ minWidth: "400px" }}>
          ...
          >
            <tr>
              <th className="px-6 py-3" style={{ width: "200px" }}>
                Image(Light Mode)
              </th>
              <th className="px-6 py-3" style={{ width: "200px" }}>
                Image(Dark mode)
            ...
            {props.cardData?.length ? (
              props.cardData.map((item, idx) => (
                ...
                >
                  <td>
                    <div
                      className={`flex justify-center ${!themeMode && "bg-gray-50"}`}
                    >
                      <Image
                        boxSize="100px"
                        objectFit="contain"
                        alt="No Image"
                        src={item.img1.toString()}
                      />
                    </div>
                  </td>
                  <td>
                    <div
                      className={`flex justify-center ${themeMode ? "bg-gray-600" : "bg-gray-700"}`}
                    >
                      <Image
                        boxSize="100px"
                        objectFit="contain"
                        alt="No Image"
                        src={item.img2.toString()}
                      />
                    </div>
                  </td>
                  <td>{item.name}</td>
